...
[OK] SCOPE mais específico (mais longo) tem prioridade
...
[OK] Matching é por prefixo, não por regex
...
[OK] Trailing slash recomendado mas não obrigatório
...
[OK] Debug: verificar qual secret será usado
...
[OK] Testing: validar configuração de SCOPEs
...
[OK] Documentation: listar mapeamentos URL -> secret
    ...
    for url in urls:
        ...
        try:
            ...
            if result:
                ...
                print(f"  [OK] {url:50} -> {name} [{scope_display}]")
...
[OK] Privilégios mínimos (least privilege)
...
[OK] Diferentes regiões otimizadas
...
[OK] Facilita rotação por bucket
...
[OK] Cost optimization (use cheapest for each use case)
...
[OK] Compliance (data residency requirements)
...
[OK] Incluir provider no nome (s3_, gcs_, azure_)
...
[OK] Consistente em todo o projeto
...
[OK] Documentar convenção no README
...
for name, scope, region in secrets_config:
    ...
    print(f"[OK] Created: {name:30} -> {scope}")
...
def export_secret_documentation(secrets_df, filename='secrets_inventory.md'):
    ...
    print(f"[OK] Documentation exported to {filename}")
...
1. Documentation:
   ...
   [OK] Manter inventário atualizado
   ...
   [OK] Documentar purpose de cada secret
   ...
   [OK] Documentar SCOPEs e seus significados
   ...
   [OK] Incluir owner/team responsável
...
2. Lifecycle Management:
   ...
   [OK] Rotação regular de credenciais
   ...
   [OK] Remoção de secrets não utilizados
   ...
   [OK] Versionamento de configurações
   ...
   [OK] Backup de persistent secrets
...
3. Security:
   ...
   [OK] Princípio de privilégio mínimo
   ...
   [OK] Secrets em variáveis de ambiente (não hardcoded)
...
4. Testing:
   ...
   [OK] Validar SCOPEs com which_secret()
   ...
   [OK] Testar em staging antes de prod
   ...
   [OK] Automated tests para configuração
...
5. Monitoring:
   ...
   [OK] Alertas para credenciais expiradas
   ...
   [OK] Detecção de secrets vazados (git-secrets, trufflehog)
