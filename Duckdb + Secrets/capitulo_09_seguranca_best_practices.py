...
1. Defense in Depth (Defesa em Profundidade)
   ...
   [OK] Access control (quem pode acessar)
   ...
   [OK] Secret rotation (atualização)
...
2. Principle of Least Privilege
   ...
   [OK] Apenas permissões necessárias
...
3. Separation of Duties
   ...
   [OK] Dev não tem prod credentials
   ...
   [OK] Diferentes secrets por ambiente
   ...
   [OK] Diferentes secrets por função
...
5. Security by Design
   ...
   [OK] Documented security practices
...
5. Credential Leakage
   ...
   [OK] Masked credentials in outputs
...
6. Stolen Credentials
   ...
   [OK] Immediate rotation on breach
...
[OK] BOM - Use Variáveis de Ambiente:
...
print("\n[OK] Secret criado usando variáveis de ambiente")
...
[OK] Documentar variáveis necessárias
...
[OK] Validar que variáveis existem antes de usar
...
print("[OK] Credentials from AWS Secrets Manager")
...
print("[OK] Credentials from Azure Key Vault")
...
print("[OK] Credentials from HashiCorp Vault")
...
[OK] Qualquer ambiente compartilhado
...
def rotate_s3_secret(con, secret_name, new_key_id, new_secret, new_region='us-east-1'):
    ...
    if new_secret_info:
        ...
        print(f"   [OK] Secret '{new_secret_info[0]}' validado")
        ...
        print(f"\n[OK] Rotação completada com sucesso!")
...
def zero_downtime_rotate(con, base_name, new_key_id, new_secret, scope):
    ...
    if test_result and test_result[0] == new_name:
        ...
        print(f"   [OK] Novo secret funcional")
    ...
    try:
        ...
        print(f"   [OK] Secret antigo removido")
    ...
    print(f"   [OK] {base_name} atualizado")
    ...
    print(f"\n[OK] Zero-downtime rotation completada!")
    ...
    def rotate_if_needed(self, secret_name, new_credentials, max_age_days=90):
        ...
        if needs_rot:
            ...
            try:
                ...
                print(f"[OK] Secret rotacionado com sucesso")
            ...
            print("[OK] Rotação não necessária")
...
Production (AWS S3):
  ...
  [OK] Dados criptografados em trânsito
...
Development (MinIO local):
  ...
  [OK] Mais rápido (sem overhead SSL)
...
MinIO Produção:
  ...
  [OK] Mesmo nível de segurança que AWS
...
[OK] Sempre USE_SSL = true em produção
...
[OK] Usar TLS 1.2+ (não TLS 1.0/1.1)
...
require:
  ...
  [OK] Proteção contra eavesdropping
...
[OK] Production: VERIFY_CA ou VERIFY_IDENTITY
...
[OK] Use client certificates quando possível
...
[OK] Rotacionar certificates regularmente
...
[OK] Export de dados com secrets
...
[OK] Encrypted data transmission
...
[OK] Encryption of cardholder data
...
[OK] Restrict access on need-to-know
