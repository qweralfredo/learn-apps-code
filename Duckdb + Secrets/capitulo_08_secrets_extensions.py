...
[OK] Suporte a S3-compatible (MinIO, Wasabi, R2)
...
[OK] Múltiplos secrets com SCOPE
...
[OK] Parquet, CSV, JSON diretamente de S3
...
[OK] Better performance for analytics
...
[OK] Direct compatibility with Hadoop/Spark
...
[OK] Query MySQL tables directly
...
print("\n[OK] mysql_scanner patterns documented")
...
[OK] ATTACH PostgreSQL databases
...
[OK] Query PostgreSQL tables directly
...
[OK] Push-down predicates and aggregations
...
[OK] Type mapping (including JSONB, arrays)
...
print("\n[OK] PostgreSQL patterns documented")
