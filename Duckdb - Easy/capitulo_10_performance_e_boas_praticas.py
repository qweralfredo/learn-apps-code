...
# ==============================================================================
print(f"--- Iniciando Capítulo 10: Performance e Boas Práticas ---")
...
# TODO: Implementar exemplos práticos para Index
# Exemplo genérico:
...
# TODO: Implementar exemplos práticos para Pragma
# Exemplo genérico:
# result = con.sql("SELECT * FROM vendas LIMIT 1").show()
...
# Tópico: Memory Limit
# -----------------------------------------------------------------------------
print(f"\n>>> Executando: Memory Limit")

# TODO: Implementar exemplos práticos para Memory Limit
# Exemplo genérico:
# result = con.sql("SELECT * FROM vendas LIMIT 1").show()
