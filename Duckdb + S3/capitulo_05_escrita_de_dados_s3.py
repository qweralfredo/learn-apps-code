...
# -----------------------------------------------------------------------------
# Tópico: Write Parquet S3
# -----------------------------------------------------------------------------
print(f"\n>>> Executando: Write Parquet S3")

# TODO: Implementar exemplos práticos para Write Parquet S3
# Exemplo genérico:
# result = con.sql("SELECT * FROM vendas LIMIT 1").show()

# -----------------------------------------------------------------------------
# Tópico: Partitioned Write S3
# -----------------------------------------------------------------------------
print(f"\n>>> Executando: Partitioned Write S3")

# TODO: Implementar exemplos práticos para Partitioned Write S3
# Exemplo genérico:
# result = con.sql("SELECT * FROM vendas LIMIT 1").show()
