...
# con.execute("SET unsafe_enable_version_guessing = true")  # [X]
...
def test_iceberg_basic():
    ...
    try:
        ...
        print("[OK] Extensão Iceberg carregada com sucesso")
        ...
        print(f"[X] Erro ao carregar Iceberg: {e}")
...
def test_iceberg_local():
    ...
    if os.path.exists(test_table):
        ...
        try:
            ...
            print(f"[OK] Tabela Iceberg lida com sucesso: {result[0]} linhas")
            ...
            print(f"[X] Erro ao ler tabela: {e}")
...
def test_iceberg_s3():
    ...
    try:
        ...
        print(f"[OK] Tabela S3 Iceberg lida: {result[0]} linhas")
...
try:
    ...
    print("[OK] Instalado e carregado com sucesso")
...
if version < '1.4.0':
    ...
    print("[WARN]  Iceberg requer DuckDB 1.4.0 ou superior")
    ...
    print("[OK] Versão compatível com Iceberg")
...
def check_s3_connectivity():
    ...
    try:
        ...
        print(f"[OK] S3 acessível (status: {response.status_code})")
        ...
        print(f"[X] Problema de conectividade: {e}")
